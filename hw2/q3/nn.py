...
from utils import load_data, load, save, display_plot, display_plot2
import numpy as np
...
def train(model, forward, backward, update, alpha, num_epochs, batch_size):
    ...
    display_plot2(train_ce_list, valid_ce_list, "Cross Entropy", number=0)
    display_plot2(train_acc_list, valid_acc_list, "Accuracy", number=1)
