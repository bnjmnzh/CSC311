...
def train(model, lr, lamb, train_data, zero_train_data, valid_data, num_epoch):
    ...
    for epoch in range(0, num_epoch):
        ...
        list_val.append(valid_acc)
        print("Epoch: {} \tTraining Cost: {:.6f}\t "
              "Valid Acc: {}".format(epoch, train_loss, valid_acc))
    return list_val, list_train_loss
...
def main():
    ...
    val_list, training_list = train(model, lr, lamb, train_matrix, zero_train_matrix,
          test_data, num_epoch)
    # p = 0
    # for i in val_list:
    #     p += i
    # print("THE FINAL VALIDATION ACCURACY IS:", p/num_epoch)

    x = np.arange(num_epoch) + 1
    plt.plot(x,val_list, label="Validation Accuracy")
